...
L["Drag to set the field of view."] = "Переместите ползунок влево или вправо, чтобы установить поле зрения."
...
L["Drag to set the vehicle seat indicator frame scale."] = "Переместите ползунок влево или вправо, чтобы установить размер фрейма индикатора сидений транспорта."
...
L["If checked, weekly quests will be accepted automatically."] = "Если флажок установлен, еженедельные задания будут автоматически приниматься."
...
L["If checked, you can hold shift while tooltips are hidden to show them temporarily."] = "Если флажок установлен, вы можете удерживать клавишу Shift, когда подсказки срыты, чтобы временно отобразить их."
...
L["If checked, you will be able to change the position and scale of the vehicle seat indicator frame."] = "Если флажок установлен, вы сможете изменять позицию и масштаб фрейма индикатора сидений транспорта."
L["If checked, you will be able to change the position and scale of the widget power frame.|n|nAn example of the widget power frame is the cosmic energy bar in Zereth Mortis."] = "Если флажок установлен, вы сможете изменить положение и масштаб рамки виджета силы.|n|nПримером виджета силы, является панель космической энергии в Зерет Мортис."
L["If checked, you will be able to change the position and scale of the widget top frame.|n|nThe widget top frame is commonly used for showing PvP scores and tracking objectives."] = "Если флажок установлен, вы сможете изменить положение и масштаб верхним виджетом.|n|nВерхний виджет обычно используется для отображения PvP счета и отслеживания целей."
...
L["If checked, you will be able to set the chat font size.|n|nThis option offers a greater range of chat font sizes than the default UI and your chosen chat font size is saved account-wide.|n|nNote that enabling this option will prevent you from using the default UI to change the chat font size."] = "Если флажок установлен, то вы сможете установить размер шрифта чата.|n|nЭтот параметр предлагает больший диапазон размеров шрифта чата, чем пользовательский интерфейс по умолчанию, и выбранный вами размер шрифта чата сохраняется для всей учетной записи.|n|nОбратите внимание, что включение этой опции не позволит вам использовать пользовательский интерфейс по умолчанию для изменения размера шрифта чата."
...
L["If checked, you will be able to set the field of view."] = "Если флажок установлен, вы сможете установить поле зрения."
...
L["Manage widget power"] = "Управление виджетом силы"
...
L["messages from previous session"] = "сообщение с предыдущей сессии"
...
L["Restore chat messages"] = "Восстановление сообщений чата"
...
L["Right"] = "Правая"
L["Right-click to cancel."] = "Правый щелчок мышью для отмены."
...
L["Set chat font size"] = "Установить размер шрифта чата"
